              ...
              <div class="card card-outline card-info">
                  <div class="card-body">
                      <div class="card card-primary">
                          ...
                          <?php
                          if (isset($_POST['room_name']) && isset($_POST['ref_room_type_id']) && isset($_POST['room_price'])) {
                              try {
                                      ...
                                      if (in_array(strtolower($typefile), $allowed_types)) {
                                          ...
                                          if (move_uploaded_file($_FILES['room_image']['tmp_name'], $path_copy)) {
                                              ...
                                              $stmtInsertRoom = $condb->prepare("INSERT INTO tbl_room
                                                  (ref_room_type_id, room_name, room_detail, room_qty, room_price, room_image)
                                                  VALUES (:ref_room_type_id, :room_name, :room_detail, :room_qty, :room_price, :room_image)
                                              ");
